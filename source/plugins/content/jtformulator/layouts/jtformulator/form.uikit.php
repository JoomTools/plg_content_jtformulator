...
$invalisColor = '#ff0000';
$invalidStylesheet =".invalid{border-color:{$invalisColor}!important;color:{$invalisColor}!important;}label.invalid{color:{$invalisColor}!important;}.uk-form-icon{display:block;}.uk-form-icon:not(.uk-form-icon-flip)>select{padding-left:40px!important;}";
